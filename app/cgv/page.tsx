  ...
  return (
    <div style={{ maxWidth: 680, margin: '0 auto', padding: '40px 20px', fontFamily: 'DM Sans, sans-serif', color: '#1C1410' }}>
      ...
      <section style={{ marginBottom: 32 }}>
        <h2 style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: 20, marginBottom: 12 }}>1. Objet</h2>
        <p style={{ fontSize: 14, lineHeight: 1.8, color: '#4A3728' }}>Les présentes CGV régissent les ventes d&apos;abonnements NYLVA par OCCIMAITRISE (Djilali Alem, Montauban 82000).</p>
      </section>
      ...
      <section style={{ marginBottom: 32 }}>
        <h2 style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: 20, marginBottom: 12 }}>4. Résiliation</h2>
      ...
      <section style={{ marginBottom: 32 }}>
        <h2 style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: 20, marginBottom: 12 }}>5. Droit applicable</h2>
