  ...
  return (
    <div style={{ maxWidth: 680, margin: '0 auto', padding: '40px 20px', fontFamily: 'DM Sans, sans-serif', color: '#1C1410' }}>
      ...
      <section style={{ marginBottom: 32 }}>
        <h2 style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: 20, marginBottom: 12 }}>1. Responsable</h2>
      ...
      <section style={{ marginBottom: 32 }}>
        <h2 style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: 20, marginBottom: 12 }}>2. Données collectées</h2>
        <ul style={{ fontSize: 14, lineHeight: 2, color: '#4A3728', paddingLeft: 20 }}>
          <li>Compte : email, prénom</li>
          <li>Profil beauté : teint, peau, sous-tons, saison, produits</li>
          <li>Photos : traitées en temps réel, non stockées durablement</li>
          <li>Paiement : géré par Stripe uniquement</li>
          <li>Miroir IA : traitement 100% local, aucune donnée envoyée</li>
        </ul>
      </section>

      <section style={{ marginBottom: 32 }}>
        <h2 style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: 20, marginBottom: 12 }}>3. Sous-traitants</h2>
        <ul style={{ fontSize: 14, lineHeight: 2, color: '#4A3728', paddingLeft: 20 }}>
          <li>Supabase (BDD, EU)</li>
          <li>Vercel (hébergement, USA — SCC)</li>
          <li>Anthropic Claude (analyse IA, USA — SCC)</li>
          <li>Stripe (paiement, USA — SCC)</li>
        </ul>
      </section>

      <section style={{ marginBottom: 32 }}>
        <h2 style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: 20, marginBottom: 12 }}>4. Vos droits</h2>
      ...
      <section>
        <h2 style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: 20, marginBottom: 12 }}>5. Cookies</h2>
