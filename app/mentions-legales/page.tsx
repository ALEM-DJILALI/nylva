  ...
  return (
    <div style={{ maxWidth:680, margin:'0 auto', padding:'40px 20px', fontFamily:'DM Sans,sans-serif', color:'#1C1410' }}>
      ...
      <section style={{ marginBottom: 32 }}>
        <h2 style={{ fontFamily:"'Cormorant Garamond',serif", fontSize:20, marginBottom:12, color:'#1C1410' }}>Éditeur</h2>
        <p style={{{{fontSize:14,lineHeight:1.8,color:"#4A3728"}}}}>NYLVA est édité par <strong>OCCIMAITRISE</strong> — Djilali Alem, Montauban (82000), France. Contact : <a href="mailto:contact@nylva.fr" style={{{{color:"#C4758A"}}}}>contact@nylva.fr</a></p>
      </section>
      <section style={{ marginBottom: 32 }}>
        <h2 style={{ fontFamily:"'Cormorant Garamond',serif", fontSize:20, marginBottom:12, color:'#1C1410' }}>Hébergement</h2>
        <p style={{{{fontSize:14,lineHeight:1.8,color:"#4A3728"}}}}>Vercel Inc. — 440 N Barranca Ave, Covina CA 91723, USA.</p>
      </section>
      <section style={{ marginBottom: 32 }}>
        <h2 style={{ fontFamily:"'Cormorant Garamond',serif", fontSize:20, marginBottom:12, color:'#1C1410' }}>Propriété intellectuelle</h2>
      ...
      <section style={{ marginBottom: 32 }}>
        <h2 style={{ fontFamily:"'Cormorant Garamond',serif", fontSize:20, marginBottom:12, color:'#1C1410' }}>Données personnelles</h2>
